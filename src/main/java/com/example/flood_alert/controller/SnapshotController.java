...
public class SnapshotController {
        ...
        @GetMapping("/regional-forecast")
        public ApiResponse<List<RegionalForecastResponse>> getRegionalForecast(
                        @RequestParam UUID areaId) {

                return ApiResponse.<List<RegionalForecastResponse>>builder()
                                .result(snapshotService.getRegionalForecast(areaId))
                                .build();
        }
